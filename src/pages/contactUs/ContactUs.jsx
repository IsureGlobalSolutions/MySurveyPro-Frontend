...
const ContactUs = ({ className = "" }) => {   
  ...
  return (   <>
   <div className="contact-main-banner">
    <div className=""> <p>Contact us</p></div>
   ...
   <div className="row m-0">
    <div className="col-md-6">
      ...
      <div className="rectangle-group">
        ...
        <div className="wrapper-rectangle-237">
          <img
            className="wrapper-rectangle-237-child"
            alt=""
            src={sideimage}
          />
        </div>
    ...
    <div className="col-md-6  contact-form-parent">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
             ...
             <div className="input-space">
                <textarea className="contact-message" placeholder='Message' rows={5} id=""></textarea>
             </div>
