...
import {
  DepartmentalDimensionAverageReportApi,
  TeiDimensionListApi,
  userSingleDimensionForAllDepartmentReportApi,
} from "../../../Redux/slice/teiSlice";
    ...
    <>
      <div className="table-card-background row  justify-content-between ">
        <div className="deparment-table-data col-md-12 p-0">
          <div className="mx-0 py-2 d-flex justify-content-between  me-0">
           
              <div className="d-flex align-items-center "
                style={{ borderRadius: "5px 5px 0px 0px" }}
              >
                <p className="table-heading ps-2 py-2  m-0">
                  Dimension report for all department
                </p>
              </div>
     ...
     <div className="d-flex gap-2">
              ...
              {listOfDimensions?.length > 0 && (
                <DropdownButton
                  ...
                  selectionName={
                    selectedOption.dimensionId || listOfDimensions[0]?.dimension
                  }
                />
              )}
</div>
