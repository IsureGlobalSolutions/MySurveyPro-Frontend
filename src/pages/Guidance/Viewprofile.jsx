...
import image1 from "../../assets/Enterprisesection-png/Profilepng.png";
...
const Viewprofile = () => {
    const firststeps = [
        {
          title: "View Profile Setting",
          description:
            "This page allows you to manage your personal information and settings",
          iconSize: 16,
        },
        {
