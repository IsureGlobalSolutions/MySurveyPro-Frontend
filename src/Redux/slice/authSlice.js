...
export const getSurveyById = createAsyncThunk('Survey/getSurveyById', async ({surveyId,surveyTypeId,designationId,employeeId,respondentRecipientId,employeeRecipientId}={}, thunkAPI) => {
  try {
    const res = await instance.get(`api/Survey/GetCompleteSurveyById`,{
      params: { surveyId, surveyTypeId,designationId,employeeId,respondentRecipientId,employeeRecipientId },
    });
    return res.data;
